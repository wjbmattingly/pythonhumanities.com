...
- [`requests`](/course/lesson-25-python-and-requests-module/) — fetches the HTML.
- [`BeautifulSoup`](/course/lesson-26-python-and-beautifulsoup/) — parses it and lets you query by tag, class, or selector.
