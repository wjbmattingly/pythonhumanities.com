...
Once you have data in hand, you'll want to save it. We start that in [Lesson 28: Storing Data in Text Files](/course/lesson-28-python-and-storing-data-in-text-files/).
