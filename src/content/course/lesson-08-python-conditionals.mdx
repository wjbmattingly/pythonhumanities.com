...
In the above example, if x is 0, we'll see "x is 0"; if x is 1, we'll see "x is 1"; and if x is 12, then we will see "x is something other than 0 or 1". The key to understanding conditionals as with most things in programming is logic. You must understand the logic behind the statement. I encourage you to spend time structuring conditional statements to get comfortable with them. You can do this in the [Lesson 08: Coding Exercise.](/course/lesson-08-coding-exercise/)
