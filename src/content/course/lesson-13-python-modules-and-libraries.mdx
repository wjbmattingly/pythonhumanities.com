...
- **`requests`** — the canonical HTTP client. We use it in Lesson 20.
- **`beautifulsoup4`** — HTML parsing. Lesson 21.
- **`openpyxl`** — read and write modern `.xlsx` files. Lessons 16–18.
- **`lxml`** — fast XML and HTML processing. Lesson 24.
