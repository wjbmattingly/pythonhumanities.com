...
Now that you understand how strings work, let's begin exploring another type of data: numbers. Numbers in Python exist in two chief forms: integers and floats. As noted in [Lesson 02](/course/lesson-02-storing-data-in-python/), **integers** are numbers without a decimal point, whereas **floats** are numbers with a decimal point. This is an important distinction that you MUST remember, especially when working with data imported from and exported to Excel.
...
5. Division `/`
6. Modulo `%` — returns the remainder, e.g. `7 % 2` yields `1`.
7. Floor `//` — returns the integer part of the division, e.g. `7 // 2` yields `3`.
...
Once you have these key concepts down, continue to [Lesson 05: Python Tuples](/course/lesson-05-python-tuples/).
