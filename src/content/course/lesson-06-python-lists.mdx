...
Working with lists becomes easier with time. You should spend ample time early in your time with Python getting acquainted with these basic functions associated with lists. You can use the Python terminal in [Lesson 06: Coding Exercise](/course/lesson-06-coding-exercise/) to experiment with them.
