...
Indexing and slicing work exactly as they do on tuples (see [Lesson 06](/course/lesson-06-python-tuples/)):
...
Spend some time in the console pushing items in and out of a list. Once you're confident, continue to [Lesson 08: Python Dictionaries](/course/lesson-08-python-dictionaries/).
