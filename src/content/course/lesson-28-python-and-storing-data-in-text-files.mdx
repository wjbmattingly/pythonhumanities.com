...
The pattern is the same one we used to read text files in [Lesson 15](/course/lesson-15-python-and-text-files/), with the file opened in **write mode** (`"w"`):
...
When you're comfortable, [Lesson 29](/course/lesson-29-python-and-storing-data-in-xml-files/) covers the last format you'll meet often: XML.
