...
Try grabbing HTML from a few sites yourself. Look at `response.status_code`, `response.encoding`, and the first hundred characters of `response.text`. When that feels routine, continue to [Lesson 26: Python and BeautifulSoup](/course/lesson-26-python-and-beautifulsoup/).
