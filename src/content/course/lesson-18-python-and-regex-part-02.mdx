...
In [Lesson 17](/course/lesson-17-python-and-regex-part-01/) we ran regex against small strings defined inside the script. Real DH work usually means running regex against a **file** — a transcript, a corpus, a chunk of OCR'd text. This lesson walks the complete cycle: read a file in, run regex over its contents, and write the results back out.
...
Once you're comfortable with regex on real files, continue to [Lesson 20: Introduction to Pandas](/course/lesson-20-introduction-to-pandas/).
